...
public class NovelIndexGenerator {
    ...
    // 数据库连接配置
    private static final String DB_URL = "jdbc:mysql://localhost:3307/novel?allowPublicKeyRetrieval=true&useSSL=false&serverTimezone=UTC";
    private static final String DB_USER = "root";
    private static final String DB_PASSWORD = "wangtianle0.";
