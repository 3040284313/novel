...
public interface TagRepository  extends JpaRepository<Tag, Long> {
    ...
    @Query("SELECT t FROM Tag t WHERE t.platform = :platform AND t.name IN :names")
    List<Tag> findByPlatformAndNameIn(@Param("platform") String platform, @Param("names") List<String> names);
}
